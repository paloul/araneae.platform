...
############################################################
# Install ArgoCD, a declarative, GitOps continuous delivery tool for Kubernetes.
...
## Use the password obtained for the argocd-initial-admin-secret a few commands above and login
## Under settings, add a new repository for https://github.com/paloul/araneae.platform.git
############################################################